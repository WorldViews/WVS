import sys, os
sys.path.append('/GitHub/WorldViews/WVS/django/Registry')
#sys.path.append("..")
...
def addProjects():
    proj = Project(name="wvtechdev",
                   ...
                   description="""
This is to build server and client software for furthering
the WorldViews mission. All our software is open source, and
built with open source components.  The content viewed may come
from a variety of sources, such as youtube, wikipedia, etc.
Our main current effort is in developing a browser tool called
TeleViewer that provides many ways to
get different views and bits of information about anywhere,
seen in the context of a digital earth model, provided by CesiumJS.
""")
    proj.save()
